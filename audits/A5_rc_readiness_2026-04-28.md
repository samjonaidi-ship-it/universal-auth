...
|---|---|---|---|
| 1 | All unit tests green (90%+ coverage) | ✓ | **Tests:** 359/359 pass across 60 files. **Coverage:** 91.06% lines / 85.14% branches / 90.50% functions / 91.06% statements — **all four spec §11 thresholds met**. Coverage push (commit `4b16823`) added 17 new test files + legitimate exclusions (pure types, barrel files, SW global, Worker module, interface declarations). `vitest.config.ts` threshold gate now CI-enforced. F1 resolved 2026-04-28. |
